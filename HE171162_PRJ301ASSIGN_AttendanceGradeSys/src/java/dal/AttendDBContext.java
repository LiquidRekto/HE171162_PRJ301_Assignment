...
public class AttendDBContext extends DBContext<Attend> {
    ...
    public void updateAttendance(ArrayList<Attend> attendList ,int sesId, String taker) {
        ...
        try {
            ...
            java.sql.Date submitDateTime = DateTimeHelper.convertUtilToSqlDate(new java.util.Date());
            ...
            for (Attend att : attendList) {
                if (att.getId() == -1) //INSERT
                {
                    ...
                    stm_insert_att.setDate(4, submitDateTime);
                ...
                {
                    String sql_update_att = "UPDATE Attend SET [Status] = ?, InstructorComment = ? WHERE AttendID = ?";
    ...
    public ArrayList<Attend> getAttendanceBySessionId(int sesId) {
        ...
        try {
            String sql = "SELECT\n" +
                         ...
                         "ISNULL(a.AttendID,-1) as AttendID,ISNULL(a.[Status],0) as [Status],ISNULL(a.TakenBy,'') as [TakenBy], ISNULL(a.[InstructorComment],'') as [Comments]\n" +
